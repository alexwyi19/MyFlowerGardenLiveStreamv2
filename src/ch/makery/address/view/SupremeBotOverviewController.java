...
//			"sweatshirts", "pants", "shorts", "t-shirts", "hats", "bags", "accessories", "skate");
	private ObservableList<String> statusList = FXCollections.observableArrayList("all", "Jackets", "Shirts", "Tops/Sweaters",
			"Sweatshirts", "Pants", "Hats", "Bags", "Accessories", "Skate");
